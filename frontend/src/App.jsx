...
const OwnerFront = lazy(() => import('./Pages/owner/OwnerFrontPage.jsx'));
const OwnerUpload = lazy(() => import('./Pages/owner/UploadBook.jsx'));
const Signup = lazy(() => import('./Pages/Signup.jsx'));
const Login = lazy(() => import('./Pages/Login.jsx'));
const AdminDashboard = lazy(() => import('./Pages/AdminDashboard.jsx'));
const AdminFront = lazy(() => import('./Pages/Admin/AdminFrontPage.jsx'));
const AdminShowBooks = lazy(() => import('./Pages/Admin/AdminShowBooks.jsx'));
const OwnerListTable = lazy(() => import('./Pages/Admin/OwnersListTable.jsx'));

const App = () => {
  const { userRole, isLoggedIn } = useSelector((state) => state.auth);

  return (
    <Container maxWidth={false} sx={{ backgroundColor: '#F5F5F5' }} disableGutters={true}>
      <BrowserRouter>
